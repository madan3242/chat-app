...
import { ApiResponseInterface, ChatListInterface, UserInterface } from "../interfaces";
...
export const getChatOjectMetadata = (chat: ChatListInterface, loggedInUser: UserInterface) => {
