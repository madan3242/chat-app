                ...
                <div>
                  <Switch.Group as="div" className="flex items-center my-5">
                    <Switch
                      ...
                      className={`${
                        isGroupChat ? "bg-purple-300" : "bg-purple-200"
                      } relative outline outline-[2px] outline-white inline-flex h-6 w-11 flex-shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:ring-0`}
                    >
                      <span
                        aria-hidden="true"
                        className={`${
                          isGroupChat
                            ? "translate-x-5 bg-purple-600"
